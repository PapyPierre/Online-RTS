...
namespace FischlWorks_FogWar
{
    ...
    public class ShowIfAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty baseProperty = property.serializedObject.FindProperty(attributeHandle.BaseCondition);
            ...
            {
                Debug.LogError("Designated property was not found : " + attributeHandle.BaseCondition);
            }
        }
    }
